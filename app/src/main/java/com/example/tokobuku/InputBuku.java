...
public class InputBuku extends AppCompatActivity {
    ...
    void submit(){
        ...
        if (kodebuku.isEmpty()){
            ...
            inputBuku(kodebuku, judulbuku, sinopsiss, pengarangg, hargaa);
        }
    }

    public void inputBuku(final String kodebuku, final String judulbuku, final String sinopsis, final String pengarang, final String harga){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config_URL.inputBuku, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status == true){
                        ...
                        Intent a = new Intent(InputBuku.this, MainActivity.class);
                        startActivity(a);
                        finish();
                    }else {
                        String msg = jObj.getString("message");
